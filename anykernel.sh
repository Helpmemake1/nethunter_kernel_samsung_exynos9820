...
properties() { '
kernel.string=NetHunter Kernel for the Samsung Galaxy S10 beyond1lte (Exynos9820)
...
do.cleanup=0
do.cleanuponabort=0
device.name1=samsung_exynos9820 beyond1lte SM-G973F exynos9820 Galaxy S10 beyond1lte-los
device.name2=
device.name3=
device.name4=
device.name5=
